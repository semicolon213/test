...
LRESULT Window::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE :
        ...
        dWindow = make_unique<DrowWindow>(hInst);
        pBW = make_unique<BlueWindow>(hInst);

        excel = make_unique<ConnExcel>();
    ...
    case WM_COMMAND:
    {
        ...
        case ID_SAVE_BUTTON:
            excel->insertExcel(EXCEL,fileManager->SaveFile());
            break;

        case CLEAR:
            function->drawInfoClear();
            break;
